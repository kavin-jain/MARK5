...
# Fix import path to work from any working directory
_KRONOS_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
if _KRONOS_DIR not in sys.path:
    sys.path.insert(0, _KRONOS_DIR)

from core.models.kronos_model.module import *
