...
- **Realistic ceiling (retail, public data) — re-measured 2026-06-10 on CLEAN data:** the
  DEPLOYED system (P9+P10: 50% momentum-heavy factor equity / 25% gold / 25% US) does
  **+18.8% net CAGR, Sharpe 0.89, MaxDD −26.7%, Calmar 0.70, +12.8%/yr alpha vs Nifty**,
  ₹5cr→₹30.1cr/10.4y — institutional/top-quartile-MF tier. **CAGR ~19% and alpha ~13% ARE
  now reached; Sharpe 1.1 and a sustained 20% are NOT** — Sharpe 1.1 @ 20% CAGR mathematically
  pins vol to ~12.7% (vs actual 22%), i.e. it needs leverage (K13 KILL) or a shorting book
  (retail can't). The 20%/Sharpe-1.1/Calmar-0.8 *joint* target is only hit in the 2022-26
  window by an un-backtestable 5-sleeve silver blend (F7 KILL, overfit). Higher raw return =
  deeper drawdown (risk-dial, not skill). **−27% drawdowns are unavoidable and must be held
  through.** The honest forward expectation for ₹5cr: ~18-19%/yr *averaged over a full cycle*,
  with single years ranging −10% to +40%. No single-year ₹5cr→₹6cr guarantee exists. **[H]**
