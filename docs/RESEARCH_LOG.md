...
- **Realistic ceiling (retail, public data) — measured, 2026-06-08:** the DEPLOYED 3-sleeve
  system (P8: 70% factor equity / 15% gold / 15% US) does **~17% net CAGR, Sharpe ~1.0,
  MaxDD −28%, +9.7%/yr alpha vs Nifty** — institutional/top-quartile-MF tier. Equity-only
  ceiling ~16% (P5). **20% sustained net is NOT reachable** — leverage killed by ~14% Indian
  financing (K13). Higher raw return = deeper drawdown (risk-dial, not skill). The honest
  lever that DID work for *risk-adjusted* return = global multi-asset diversification (P7→P8),
  not more signals. **−28% drawdowns are unavoidable and must be held through.** **[H]**
