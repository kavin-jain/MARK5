...
|---|---|---|
| Net CAGR | **+20.9%** | +10.9% |
| Volatility (ann.) | 15.1% | 14.9% |
| Sharpe (rf=0, raw) | 1.36 | 0.79 |
| **Sharpe (excess of 6.5% risk-free)** | **0.94** | 0.36 |
| Sortino | 1.24 | 0.48 |
| Max drawdown | -22.2% | -36.3% |
| Calmar | 0.94 | 0.30 |
| Excess return vs Nifty 50 TRI | **+9.9pp** | — |
| Jensen's α vs Nifty 50 (CAPM, single-factor) | +12.9%/yr | — |
| Factor+refresh alpha (vs equal-weight same universe, computed) | **+8.6pp/yr** | — |
| Beta vs Nifty | 0.61 | 1.00 |
| Max-DD recovery | 71 days | — |

₹500,000 → **₹3,695,650** over 10.6 years (net).

## 2. Trade ledger (evidence)

- Total trades: **869** (332 buys, 537 sells) over 10.6 years — full detail in `reports/trade_ledger.csv`.
- **Win rate: 65%** (348 wins / 189 losses on closed sells).
- **Profit factor: 2.73** (₹4,585,820 gross profit / ₹1,678,583 gross loss).
- Tax efficiency: 135/537 sells qualified for LTCG (long holds).
- Avg holding period: 222 days.

  Largest winners (₹, scaled to capital):

  | date | ticker | held(d) | P&L ₹ |
  |---|---|---|---|
  | 2024-09-09 | ANANTRAJ | 378 | 140,856 |
  | 2024-09-09 | RECLTD | 378 | 127,778 |
  | 2024-09-09 | PFC | 378 | 115,021 |
  | 2024-09-09 | RVNL | 566 | 103,786 |
  | 2024-03-01 | CGPOWER | 928 | 101,257 |
  | 2024-03-01 | PFC | 186 | 92,473 |
  | 2024-03-01 | UJJIVAN | 374 | 79,165 |
  | 2024-03-01 | RECLTD | 186 | 75,950 |
...
| COVID crash 2020 | +3.5% | -16.3% | -22.2% |
| 2022 bear/rate-shock | -12.8% | -10.0% | -20.5% |
| 2024-25 correction | -2.2% | -6.5% | -13.6% |

## 5. Monte Carlo — unpredicted-event robustness (2000 block-bootstrap 5-yr paths)

- Median 5-yr CAGR: **+23.7%** | 5th-percentile (bad luck): +11.2% | 95th: +37.0%
- Worst simulated drawdown: **-50.5%** | 5th-pctile DD: -29.4%
...
|---|---|---|---|
| Sharpe (excess of rf) | 0.94 | MF ~0.5-0.8, HF ~1.0, Medallion ~2+ | strong (top-quartile MF) |
| Calmar | 0.94 | >0.5 good, >1.0 excellent | good |
| Jensen's α vs Nifty 50 | +12.9%/yr | >0 = adds value (note: partly multi-asset) | positive |
| Max drawdown | -22.2% | equity norm -30 to -55% | within norm |
| Beta | 0.61 | <1 = defensive | defensive |

## 7. Honest verdict

- **Excess Sharpe 0.94, excess return +9.9pp vs Nifty 50 TRI, Calmar 0.94** — a genuine, index-beating smart-beta portfolio in the strong-MF tier. (The full excess return reflects multi-asset allocation + universe + factor; factor ranking + 6-mo refresh contributes +8.6pp/yr above equal-weight of the same universe — the rest is asset allocation any multi-asset fund also captures.)
