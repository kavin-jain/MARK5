...
- Observed Sharpe: **0.90** annualised (0.057 daily)
- Probabilistic Sharpe Ratio vs 0 (P true SR>0): **99.7%**
- Expected max Sharpe from pure luck across 60 trials: 0.15 annualised
- **Deflated Sharpe Ratio (P skill survives multiple-testing): 99.1%**

## Probability of Backtest Overfitting (PBO via CSCV)

- Strategies in matrix: 60 | train/test combos: 924
- **PBO: 73.4%** (fraction of splits where the in-sample-best strategy lands below the out-of-sample median)
...
- PBO WEAK: 73% — elevated overfitting risk.
