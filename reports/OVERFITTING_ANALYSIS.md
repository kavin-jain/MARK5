...
- Observed Sharpe: **0.95** annualised (0.060 daily)
...
- **PBO: 76.7%** (fraction of splits where the in-sample-best strategy lands below the out-of-sample median)
...
- PBO WEAK: 77% — elevated overfitting risk.
