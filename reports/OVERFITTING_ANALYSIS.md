...
- Observed Sharpe: **0.97** annualised (0.061 daily)
- Probabilistic Sharpe Ratio vs 0 (P true SR>0): **99.9%**
- Expected max Sharpe from pure luck across 124 trials: 0.41 annualised
- **Deflated Sharpe Ratio (P skill survives multiple-testing): 96.1%**

## Probability of Backtest Overfitting (PBO via CSCV)

- Strategies in matrix: 70 | train/test combos: 924
- **PBO: 42.4%** (fraction of splits where the in-sample-best strategy lands below the out-of-sample median)
- Median performance-degradation logit: 0.20 (positive = robust)

## Verdict

- DSR PASS: deflated-Sharpe 96% — the Sharpe survives multiple-testing; >95% confidence it is skill, not the luckiest draw.
- PBO WEAK: 42% — elevated overfitting risk.
